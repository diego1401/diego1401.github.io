...
// --- Toggle between 3DGS (PlayCanvas) and Mesh (model-viewer) ---
...
function toggleView() {
    ...
    if (!pcApp || !meshViewer || !btn) return;
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    syncBgColor();
    syncModelViewerBg();
    new MutationObserver(() => { syncBgColor(); syncModelViewerBg(); }).observe(document.documentElement, { attributeFilter: ['class'] });

...
function playVids(videoId) {
    ...
    var comparedvid = document.getElementById(videoId + "Right");

    var position = 0.5;
    var vidWidth = comparedvid.videoWidth;
    var vidHeight = comparedvid.videoHeight;
    ...
    if (vid.readyState > 3) {
        ...
        function drawLoop() {
            ...
            mergeContext.drawImage(vid, 
                                    0, 0, vidWidth-colWidth, vidHeight, 
                                    0, 0, vidWidth-colWidth, vidHeight);
            mergeContext.drawImage(comparedvid, 
